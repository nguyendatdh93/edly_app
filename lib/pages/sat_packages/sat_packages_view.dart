...
import 'package:edupen/pages/sat_packages/sat_packages_constants.dart';
import 'package:edupen/pages/sat_packages/sat_packages_controller.dart';
...
class _DrawerTile extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Material(
      color: selected ? SatPackagesPalette.chip : Colors.transparent,
      ...
      child: ListTile(
        ...
        leading: Icon(
          icon,
          color: selected
              ? SatPackagesPalette.primary
              : SatPackagesPalette.textSecondary,
        ),
        title: Text(
          title,
          style: TextStyle(
