...
class _CourseDetailViewState extends State<CourseDetailView> {
  ...
  LearningDockTab _resolveDockTab() {
    ...
    if (signature.contains('menu') || signature.contains('tài khoản')) {
      return LearningDockTab.account;
    }
...
class _PurchaseCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final currentPriceLabel =
        ...
        (currentPrice != null ? '${currencyFormat.format(currentPrice)}đ' : null);
...
class _CourseSectionTile extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final sectionBg = isHidden ? const Color(0xFFF8FAFC) : Colors.white;
...
class _TimelineLearningItem extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final actionLabel = isFree
        ...
        : (item.canOpen ? 'Học ngay' : 'Mua ngay');
            ...
            child: Column(
              children: [
                Container(
                  ...
                  child: Icon(iconData, size: 16, color: toneColor),
                ),
                if (!isLast)
                  Expanded(
                    child: Container(
                      ...
                      children: [
                        ...
                        Wrap(
                          ...
                          children: [
                            ...
                            _InlineChip(
                              label:
                                  isFree ? 'Miễn phí' : _formatVnd(item.price),
                        ...
                        if (item.metaLabel != null &&
                            item.metaLabel!.trim().isNotEmpty) ...[
                          const SizedBox(height: 10),
                          Text(
                            item.metaLabel!,
