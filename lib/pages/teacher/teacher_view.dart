...
import 'package:edupen/pages/teacher/teacher_classroom_list_view.dart';
import 'package:edupen/pages/teacher/teacher_course_library_view.dart';
...
class _TeacherViewState extends State<TeacherView> {
  ...
  Future<void> _openCourseLibrary() async {
    await Navigator.of(context).push(
      MaterialPageRoute<void>(
        builder: (_) => const TeacherCourseLibraryView(),
      ),
    );
  }
